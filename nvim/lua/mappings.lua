...
-- Keybinds in insert mode -- mappings.lua

-- Map Ctrl-G to delete the character before the cursor in insert mode
vim.api.nvim_set_keymap('i', '<C-g>', '<C-h>', { noremap = true, silent = true })

-- Ensure Ctrl-H still moves the cursor left
vim.api.nvim_set_keymap('i', '<C-h>', '<Left>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-h>', 'h', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-j>', 'j', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-k>', 'k', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-l>', 'l', { noremap = true, silent = true })
